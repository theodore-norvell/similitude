...
var Changepassword = function() {
	this.b = window.document.getElementById("login");
	this.b.addEventListener("click",$bind(this,this.regist),false);
};
$hxClasses["Changepassword"] = Changepassword;
Changepassword.__name__ = ["Changepassword"];
Changepassword.main = function() {
...
Changepassword.prototype = {
	...
	,regist: function() {
		...
		} else if(oldpass != "" && newpass != "" && confirm != "") {
			var s = { oldp : oldpass, newp : newpass};
			var o = tjson_TJSON.encode(s);
			$.ajax({ type : "post", url : "http://127.0.0.1:3000/changepassword/users?username=" + username, contentType : "application/json", data : o}).done(function(text) {
				if(text == "y") {
					haxe_Log.trace("logged in",{ fileName : "Changepassword.hx", lineNumber : 41, className : "Changepassword", methodName : "regist"});
				...
				if(text == "n") {
					haxe_Log.trace("fail",{ fileName : "Changepassword.hx", lineNumber : 52, className : "Changepassword", methodName : "regist"});
					$("#oldpasstag").html("Wrong password");
				}
