...
### Minifiers
  ...
  - [uglify-bin.css](https://github.com/visionmedia/bin.css) - No need to install anything, just minifies/beautifies CSS
...
### Other
  ...
  - cdata-bin.css - as `cdata`, but with surrounding comments suitable for inclusion into a HTML/CSS `<style>` block: `/*<![CDATA[*/\n${INPUT_STRING\n/*]]>*/`.
  ...
  - [component-bin.css](http://documentup.com/component/component) [(website)](http://component.io) - `npm install component-builder` options: `{development: false}`
