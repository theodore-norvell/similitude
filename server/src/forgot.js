...
$hxClasses["Forgot"] = Forgot;
Forgot.__name__ = ["Forgot"];
Forgot.main = function() {
	var main = new Forgot();
};
Forgot.prototype = {
	b: null
	,regist: function() {
		...
		if(username != "") {
			var u = new User(username,null,null);
			var o = tjson_TJSON.encode(u);
			$.ajax({ type : "post", url : "http://127.0.0.1:3000/forgot/users?username=" + username, contentType : "application/json", data : o}).done(function(text) {
				if(text == "y") {
					haxe_Log.trace("logged in",{ fileName : "Forgot.hx", lineNumber : 29, className : "Forgot", methodName : "regist"});
				...
				if(text == "n") {
					haxe_Log.trace("fail",{ fileName : "Forgot.hx", lineNumber : 40, className : "Forgot", methodName : "regist"});
