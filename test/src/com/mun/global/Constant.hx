...
class Constant {
    ...
    public static var TRANSFORM_X_DELTA = 30;
    public static var TRANSFORM_Y_DELTA = 30;
    public static var TRANSFORM_ZOOM_IN_RATE = 1.5;
    public static var TRANSFORM_ZOOM_OUT_RATE = 0.5;
    public function new() {
    }
}
